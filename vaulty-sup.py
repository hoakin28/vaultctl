...
def read_args():
    ...
    parser.add_argument("--policy", help="Specify to do something with policies [s, -g] EX: --policy -g", action='store_true')
    ...
    #parser.add_argument("-d", "--delete", help = argparse.SUPPRESS) #help="Delete a secret/policy")
